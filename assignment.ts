...
export const oddNumbers = numbers.filter(n => n % 2 === 1);

// numbers 배열을 이용해 모든 숫자를 2배한 새 배열을 만드세요.
export const doubledNumbers = numbers.map(n => n * 2);

// numbers 배열을 돌면서 홀수가 있으면 문자열 '홀수'를 출력하고, 짝수가 있으면 문자열 '짝수'를 출력하세요.
numbers.forEach(n => console.log(n % 2 === 1 ? "홀수" : "짝수")); // 여기에 코드 작성

// numbers 배열의 합을 구하세요.
export const sumOfNumbers = numbers.reduce((sum, num) => sum + num, 0);
